...
class OwnerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $last = DB::table('owner')->orderBy('owner_no', 'desc')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $oldImage = DB::table('owner')->where('owner_no', $id)->value('image_path');
        ...
        DB::table('owner')->where('owner_no', $id)->update($data);
    ...
    {
        DB::table('owner')->where('owner_no', $id)->delete();
