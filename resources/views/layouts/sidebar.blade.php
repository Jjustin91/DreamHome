    ...
    <div class="flex flex-col justify-between flex-1 mt-2">
        <nav class="-mx-3 space-y-2">
            ...
            @role('Manager')
                ...
                <a class="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg {{ request()->is('staff*') ? 'bg-dh-forest text-dh-light' : 'text-dh-light/80 hover:bg-dh-forest hover:text-dh-light' }}" href="/staff">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 {{ request()->is('staff*') ? 'text-dh-sand' : '' }}">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    <span class="mx-2 text-sm font-medium">Manage Staff</span>
                </a>

                <a class="flex items-center px-3 py-2 mt-2 transition-colors duration-300 transform rounded-lg {{ request()->is('reports*') ? 'bg-dh-forest text-dh-light' : 'text-dh-light/80 hover:bg-dh-forest hover:text-dh-light' }}" href="/reports/branch">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 {{ request()->is('reports*') ? 'text-dh-sand' : '' }}">
            ...
            @hasanyrole('Super Admin|Manager|Supervisor')
                ...
                <a class="flex items-center px-3 py-2 mt-2 transition-colors duration-300 transform rounded-lg {{ request()->is('clients*') ? 'bg-dh-forest text-dh-light' : 'text-dh-light/80 hover:bg-dh-forest hover:text-dh-light' }}" href="/clients">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 {{ request()->is('clients*') ? 'text-dh-sand' : '' }}">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </svg>
                    <span class="mx-2 text-sm font-medium">Clients & Renters</span>
                </a>
                
                <a class="flex items-center px-3 py-2 mt-2 transition-colors duration-300 transform rounded-lg {{ request()->is('leases*') ? 'bg-dh-forest text-dh-light' : 'text-dh-light/80 hover:bg-dh-forest hover:text-dh-light' }}" href="/leases">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 {{ request()->is('leases*') ? 'text-dh-sand' : '' }}">
