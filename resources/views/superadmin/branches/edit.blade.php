            ...
            <div class="p-8">
                <form action="{{ route('branches.update', $branch->branch_no) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label class="block text-sm font-bold tracking-wide text-dh-charcoal">Branch Number</label>
                            <input type="text" value="{{ $branch->branch_no }}" readonly 
                        ...
                        <div>
                            ...
                            <input type="text" id="telephone_no" name="telephone_no" value="{{ old('telephone_no', $branch->telephone_no) }}" required 
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="street" name="street" value="{{ old('street', $branch->street) }}" required 
                                class="block w-full mt-2 bg-white border-gray-300 rounded-lg shadow-sm text-dh-charcoal focus:border-dh-forest focus:ring focus:ring-dh-forest/30">
                        ...
                        <div>
                            ...
                            <input type="text" id="area" name="area" value="{{ old('area', $branch->area) }}" 
                                class="block w-full mt-2 bg-white border-gray-300 rounded-lg shadow-sm text-dh-charcoal focus:border-dh-forest focus:ring focus:ring-dh-forest/30">
                        ...
                        <div>
                            ...
                            <input type="text" id="postcode" name="postcode" value="{{ old('postcode', $branch->postcode) }}" required 
                                class="block w-full mt-2 bg-white border-gray-300 rounded-lg shadow-sm text-dh-charcoal focus:border-dh-forest focus:ring focus:ring-dh-forest/30">
                        ...
                        <div>
                            ...
                            <input type="text" id="fax_no" name="fax_no" value="{{ old('fax_no', $branch->fax_no) }}" 
                                class="block w-full mt-2 bg-white border-gray-300 rounded-lg shadow-sm text-dh-charcoal focus:border-dh-forest focus:ring focus:ring-dh-forest/30">
