        ...
        <div class="overflow-hidden bg-white shadow-lg sm:rounded-xl">
            <div class="p-8 border-b border-gray-200">
                ...
                <form action="{{ route('viewings.store') }}" method="POST">
                    ...
                    <h3 class="mb-4 text-lg font-semibold text-dh-forest border-b pb-2">Viewing Details</h3>
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mb-8">
                        
                        <div>
                            <label for="renter_no" class="block text-sm font-medium text-gray-700">Prospective Renter</label>
                            <select name="renter_no" id="renter_no" required class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-dh-forest focus:border-dh-forest">
                                <option value="" disabled selected>-- Choose a Renter --</option>
                        ...
                        <div>
                            <label for="property_no" class="block text-sm font-medium text-gray-700">Property to View</label>
                        ...
                        <div>
                            <label for="staff_no" class="block text-sm font-medium text-gray-700">Assigned Staff</label>
                        ...
                        <div>
                            <label for="viewing_date" class="block text-sm font-medium text-gray-700">Viewing Date</label>
                            <input type="date" name="viewing_date" id="viewing_date" required class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-dh-forest focus:border-dh-forest">
                        </div>

                        <div class="md:col-span-2">
                            <label for="feedback" class="block text-sm font-medium text-gray-700">Initial Feedback (Optional)</label>
                            <textarea name="feedback" id="feedback" rows="2" placeholder="Any initial notes from the renter?" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-dh-forest focus:border-dh-forest"></textarea>
                        </div>
